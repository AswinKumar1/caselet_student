...
const StudentDashboard = () => {
  // Get upcoming caselets (first 3 from mock data)
  ...
  // Calculate completion percentage for learning path
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-gray-800">Skill Progress</h2>
                <a href="/skills" className="text-blue-600 hover:text-blue-800 text-sm font-medium">
                  View All Skills
                </a>
              </div>
              <div className="space-y-5">
                <SkillBar name="Data Mining" progress={85} color="bg-blue-500" />
                <SkillBar name="Machine Learning" progress={72} color="bg-indigo-500" />
                <SkillBar name="Statistical Analysis" progress={64} color="bg-purple-500" />
                <SkillBar name="Data Visualization" progress={78} color="bg-green-500" />
              </div>
            </div>
...
const SkillBar = ({ name, progress, color }) => {
  return (
    <div>
      ...
      <div className="w-full bg-gray-200 rounded-full h-2.5">
        <div className={color} style={{ width: `${progress}%`, height: '0.625rem', borderRadius: '0.5rem' }}></div>
      </div>
    </div>
  );
};
