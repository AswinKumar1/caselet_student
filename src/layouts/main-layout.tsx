  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
          ...
          <div className="hidden md:flex items-center flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-sm border border-gray-300 rounded-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none bg-gray-50"
              />
            </div>
          </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <aside
          className={`bg-white border-r border-gray-200 w-64 flex-shrink-0 fixed md:sticky top-[61px] h-[calc(100vh-61px)] z-20 transition-transform duration-300 transform ${
          ...
          <div className="h-full flex flex-col overflow-y-auto py-4">
            ...
            <div className="px-4 mt-6">
              <div className="pt-4 border-t border-gray-200">
                ...
                <button className="flex w-full items-center px-3 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 mt-1">
